...
if uploaded_file is not None:
    ...
    with col2:
        ...
        if st.button("Detect Emotions", key="detect_button"):
            ...
            results_placeholder = st.empty() # Create a single placeholder for all results
            ...
            try:
                ...
                if not cap.isOpened():
                    ...
                    if results:
                        ...
                        # Use the placeholder to show all results together
                        with results_placeholder.container():
                            st.subheader("Overall Analysis")
                            
                            # *** NEW: Calculate and display the primary emotion ***
                        ...
                        results_placeholder.warning("No faces were detected in the video.")
